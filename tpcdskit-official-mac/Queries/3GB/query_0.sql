...
where 
	...
	and d_date between cast('1998-04-23' as date) 
				and (cast('1998-04-23' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast('2001-04-29' as date) 
 				and (cast('2001-04-29' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
and d_date between '2002-01-03' and 
        (cast('2002-01-03' as date) + 90 days)
...
select  i_item_id
 ...
 and d_date between cast('2000-04-13' as date) and (cast('2000-04-13' as date) +  60 days)
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-10' as date) 
                  and (cast('1998-08-10' as date) +  30 days)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-05-01' as date) and (cast('2001-05-01' as date) +  60 days)
...
and d_date between '2002-03-20' and 
        (cast('2002-03-20' as date) + 90 days)
...
where 
	...
	and d_date between cast('2001-01-17' as date) 
				and (cast('2001-01-17' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
